...
nome_binaria, tentativas_binaria = pesquisa_binaria(lista, 256)
nome_sequencial, tentativas_sequencial = pesquisa_sequencial(lista, 256)

print(f"Nome associado ao número 256: {nome_binaria}")
print(f"Pesquisa binária: {tentativas_binaria} tentativas")
print(f"Pesquisa sequencial: {tentativas_sequencial} tentativas")